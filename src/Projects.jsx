...
import Recipes from "./files/Recipes.webp";
import BookStore from "./files/BookStore.avif";
const Projects = () => {
  return (
    <div
      id="projects"
      className="text-white dancing-script-500 max-w-7xl mx-auto py-6 px-10"
    >
      <h1
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-14">
        {/* Ecommerce Web App - Commented out
        <div
        ...
        */}
        {/* Movie Details Web App (Flixpedia) - Commented out
        <div
          className="data rounded-2xl relative overflow-hidden shadow-[-10px_-10px_0px_rgb(242,242,242)] sm:shadow-[20px_-20px_0px_rgb(242,242,242)]"
          data-aos="zoom-in"
          data-aos-duration="700"
        ...
        */}
        ...
        >
          ...
          <div className="projectinfo px-2 min-[400px]:px-4 md:px-10">
            <h3 className="text-base md:text-xl lg:text-2xl mb-2 md:mb-3 lg:mb-5 text-yellow-300">
              Delhi Peak Power Demand
            </h3>
            <p className="text-sm md:text-base lg:text-lg text-gray-200 mb-2 md:mb-3 lg:mb-5">
              Analyze and visualize Delhi's electric power consumption patterns with real-time data insights and peak demand forecasting.
            </p>
            <div>
              <a href="https://delhi-electric-power-demand-peaks.onrender.com/" target="_blank">
                <i className="fa-solid fa-arrow-up-right-from-square rounded-full p-3 lg:p-5 text-lg lg:text-xl bg-white text-[#63e]"></i>
              </a>
            </div>
          </div>
        ...
        >
          ...
          <div className="projectinfo px-2 min-[400px]:px-4 md:px-10">
            ...
            <p className="text-sm md:text-base lg:text-lg text-gray-200 mb-2 md:mb-3 lg:mb-5">
              Deep startup ecosystem analytics platform providing comprehensive insights for venture capital, financial modeling, and investor matchmaking.
            </p>
            <div>
              {/* Live link removed - blank */}
            </div>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="projectinfo px-2 min-[400px]:px-4 md:px-10">
            <h3 className="text-base md:text-xl lg:text-2xl mb-2 md:mb-3 lg:mb-5 text-yellow-300">
              IntervNext AI Mock Interview Platform
            </h3>
            <p className="text-sm md:text-base lg:text-lg text-gray-200 mb-2 md:mb-3 lg:mb-5">
              AI-powered mock interview platform for technical preparation with real-time feedback, personalized coaching, and comprehensive performance analytics.
            </p>
            <div>
              <a href="https://intervnext-web-m6hr.onrender.com/" target="_blank">
                <i className="fa-solid fa-arrow-up-right-from-square rounded-full p-3 lg:p-5 text-lg lg:text-xl bg-white text-[#63e]"></i>
              </a>
            </div>
          </div>
        ...
        >
          ...
          <div className="projectinfo px-2 min-[400px]:px-4 md:px-10">
            ...
            <p className="text-sm md:text-base lg:text-lg text-gray-200 mb-2 md:mb-3 lg:mb-5">
              BookStore is a user-friendly book website that offers a wide range
              of books from around the world.
            </p>
            <div>
              <a href="https://bookstore2024.vercel.app/" target="_blank">
                <i className="fa-solid fa-arrow-up-right-from-square rounded-full p-3 lg:p-5 text-lg lg:text-xl bg-white text-[#63e]"></i>
              </a>
            </div>
          </div>
