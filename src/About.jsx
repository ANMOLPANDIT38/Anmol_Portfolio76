    ...
    >
      ...
      >
        <img
          src={Profile}
          alt=""
          className="h-[25rem] bg-[#63e] rounded-3xl shadow-[8px_-16px_0px_rgb(242,242,242)] lg:shadow-[26px_-20px_0px_rgb(242,242,242)] object-cover object-top"
        />
      </div>
      <div
      ...
      >
        ...
        <p className="mb-6">
          I am <span className="text-[#63e]">Anmol Kumar Pandit</span> and currently
          pursuing Bachelor of Technology from University School of Automation and Robotics.
          I am a Web Developer and passionate programmer
          ...
          <div>
            ...
            <ul>
              <li className="mb-4">
                ...
                <br />
                Pursuing B.Tech in Artificial Intelligence & Data Science from University School of Automation and Robotics.
              </li>
              <li className="mb-4">
                <span className="text-[#63e]">2022</span>
                <br />
                12th from Govt. Co-Ed. Sr. Sec. School, Sector-2, Dwarka, New Delhi.
              </li>
              <li className="mb-4">
                <span className="text-[#63e]">2020</span>
                <br />
          ...
          <div>
            ...
            <ul>
              ...
              <li className="mb-4">
                ...
                <a
                  href="https://leetcode.com/u/AkPandit24/"
                ...
                and{" "}
                <a
                  href="https://codeforces.com/profile/Pandit_KP"
                  target={"_blank"}
                  className="text-[#a0a0b8]"
                >
                  Codeforces
