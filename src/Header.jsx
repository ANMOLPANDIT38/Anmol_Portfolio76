...
export default function Example() {
  ...
  React.useEffect(() => {
    const typed = new Typed(el.current, {
      strings: ["Software Developer", "AIML Developer"],
      typeSpeed: 100,
      backSpeed: 100,
      backDelay: 1000,
      loop: true,
      ...
      >
        ...
        >
          <a href="/" className="-m-1.5 p-1.5 text-5xl">
            <span className="text-[#63e]">AKP</span>
          </a>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 dancing-script-500 max-w-7xl mx-auto min[500px]:my-8 p-6 lg:px-8">
        ...
        >
          ...
          <div className="social-media mb-6">
            <a href="https://wa.me/917678585768" target={"_blank"}>
              <i className="fa-brands fa-whatsapp mr-3 mb-3 min-[410px]:mr-6 min-[410px]:mb-6"></i>
            </a>
            <a href="mailto:anmolpandit38@gmail.com" target={"_blank"}>
              <i className="fa-solid fa-envelope mr-3 mb-3 min-[410px]:mr-6 min-[410px]:mb-6"></i>
            </a>
            <a
              href="https://instagram.com/anmolprajapati2004"
              target={"_blank"}
            >
              <i className="fa-brands fa-instagram mr-3 mb-3 min-[410px]:mr-6 min-[410px]:mb-6"></i>
            </a>
            <a
              href="https://www.linkedin.com/in/akpandit24/"
              target={"_blank"}
            >
              <i className="fa-brands fa-linkedin-in mr-3 mb-3 min-[410px]:mr-6 min-[410px]:mb-6"></i>
            </a>
            <a href="https://github.com/ANMOLPANDIT38" target={"_blank"}>
        ...
        >
          <img
            src={Profile}
            className="object-contain object-center h-[35rem] w-[20rem] bg-[#63e] rounded-2xl shadow-[20px_20px_0px_rgb(242,242,242)] min-[400px]:shadow-[30px_30px_0px_rgb(242,242,242)] up-down"
          ></img>
        </div>
      </div>
    </header>
